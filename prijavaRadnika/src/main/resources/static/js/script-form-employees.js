...
function toggleDatePickButtons() {
    setTimeout(function() {
        ...
        datePickContainers.forEach(function(container) {
            ...
            if (!input || !clearButton || !datePickerButton) return; // Provjeravamo jesu li elementi pronađeni

            // Provjeravamo prisutnost atributa disabled ili ako je atribut postavljen na "true"
...
//      foreignNationalCheckbox.addEventListener('change', foreignNationalCheckbox);
